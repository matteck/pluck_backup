...
for domain in ["pluck2", "pluck"]:
    ...
    for media_type in ["video","photo"]:
        ...
        download_url_regex = re.compile('<a href="(http://%s.abc.net.au/ver1.0/Content/%ss/Store/Main/[a-f0-9-]+/[a-f0-9-]+/[a-f0-9-]+\.[^"]+)"' % (domain,media_type), flags=re.I)
